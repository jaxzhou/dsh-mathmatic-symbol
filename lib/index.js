  ...
  switch (type) {
    ...
    case "ray": {
      ...
      state.lines.push({
        ...
        width: numberField(element, "width", path4, DEFAULT_STROKE),
        style: readStyle(element, path4),
        arrow: readArrow(element, path4, type === "ray" ? "end" : "none"),
...
async function publishSvg(input) {
  ...
  const pngImage = pngPath !== null && pngSize !== void 0 ? { relativePath: pngPath, width: pngSize.width, height: pngSize.height } : void 0;
